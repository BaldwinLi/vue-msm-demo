                    ...
                    <el-row :gutter="10">
                        ...
                        <el-col :span="6">
                            <el-form-item :label="i18n['form_review_type']" prop="approveType">
                                <el-col :span="20">
                                    <el-select v-model="mypendingForm.approveType" clearable :placeholder="i18n['please_select']">
                        ...
                        <el-col :span="6">
                            <el-form-item :label="i18n['form_search_type']" prop="templateCode">
                                <el-col :span="20">
                                    <el-select v-model="mypendingForm.templateCode" clearable :placeholder="i18n['please_select']">
                                        <!-- <el-option :label="i18n['please_select']" value=""></el-option> -->
